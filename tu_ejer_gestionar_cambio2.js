...
//   let precio = document.getElementById("precio_articulo").value;
//   let montoIngresado = document.getElementById("monto_ingresado").value;
//   let vuelto = montoIngresado - precio;
  
//   document.getElementById("solicitud").innerText = `Aqui ${precio} ${montoIngresado} ${vuelto}`;
